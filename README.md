...
* **DAX (Data Analysis Expressions):** Created advanced measures to calculate Year-over-Year (YoY) growth, Profit Margins, and Total Quantity Sold.  
* **Interactive Features:** Implemented drill-through capabilities and bookmarks to navigate between high-level overviews and detailed product insights.
